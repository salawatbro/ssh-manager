...
Actively developed. Current milestone: **v0.5** — `~/.ssh/config` import and a
full settings surface, on top of server management (v0.1), keychain-backed
connections (v0.2), the terminal (v0.3), and the palette/hotkeys/tray (v0.4).
Upcoming: port forwarding and jump-host connections.
